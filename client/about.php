        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-xs-center">
                    <h3 class="mbr-section-title display-2">AUTHORS</h3>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-xs-12 col-md-3 col-lg-3">
                    <div class="mbr-testimonial card mbr-testimonial-lg">
                        ...
                        <div class="mbr-author card-footer">
                            ...
                            <div class="mbr-author-name">Julian Nyča</div>
                        </div>
                    </div>
                </div>
				<div class="col-xs-12 col-md-3 col-lg-3">
                    <div class="mbr-testimonial card mbr-testimonial-lg">
                        ...
                        <div class="mbr-author card-footer">
                            ...
                            <div class="mbr-author-name">Soňa Mikulová</div>
                        </div>
                    </div>
                </div>
				<div class="col-xs-12 col-md-3 col-lg-3">
                    <div class="mbr-testimonial card mbr-testimonial-lg">
                        ...
                        <div class="mbr-author card-footer">
                            ...
                            <div class="mbr-author-name">Suzana Stanković</div>                            
                        </div>
                    </div>
                </div>
				<div class="col-xs-12 col-md-3 col-lg-3">
                    <div class="mbr-testimonial card mbr-testimonial-lg">
                        ...
                        <div class="mbr-author card-footer">
                            <div class="mbr-author-img"><img src="assets/images/face2.jpg" class="img-circle"></div>
                            <div class="mbr-author-name">Anđelka Zečević</div>                            
                        </div>
                    </div>
                </div>
            </div>
